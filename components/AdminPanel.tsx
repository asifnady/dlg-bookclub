...
/**
 * Admin Panel window content. Used in two places:
 * - On the Win95 desktop as a floating window (pass onClose for the ✕ button)
 * - Standalone at /admin (pass backHref="/" for the "Back to App" link)
 */
export default function AdminPanel({ onClose, backHref, onMinimize }: {
  onClose?: () => void;
  backHref?: string;
  onMinimize?: () => void;
}) {
  ...
  return (
    <div className="flex flex-col h-full min-h-0" style={{ fontFamily: "'MS Sans Serif', 'Microsoft Sans Serif', Tahoma, sans-serif" }}>
      {/* Title bar */}
      <div className="bg-[#000080] flex items-center justify-between px-[3px] py-[3px] flex-shrink-0">
        ...
        <div className="flex gap-[2px] items-center">
          {backHref && (
            <a href={backHref} className="text-white text-[10px] underline hover:text-blue-200 mr-1">Back to App</a>
          )}
          {onMinimize && (
            <button
              onClick={onMinimize}
      ...
      {/* Window body */}
      <div className="bg-[#c0c0c0] border-l-[2px] border-t-[2px] border-white border-r-[2px] border-b-[2px] border-black flex-1 flex flex-col overflow-hidden min-h-0">
        {/* Tab bar */}
        <div className="flex border-b border-gray-400 flex-shrink-0">
          <button
      ...
      {/* Status bar */}
      <div className="bg-[#c0c0c0] border-l-[2px] border-t-[2px] border-white border-r-[2px] border-b-[2px] border-black px-[3px] py-[2px] flex items-center flex-shrink-0">
